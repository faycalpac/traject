...
// ----------------------------------------------------------------------------
// [[Rcpp::export]]
NumericVector CEM_cpp(NumericVector param,
                      int ng,
                      int nx,
                      IntegerVector nbeta,
                      int n,
...
// ----------------------------------------------------------------------------
// [[Rcpp::export]]
NumericVector CEMCensored_cpp(NumericVector param,
                              int ng,
                              int nx,
                              IntegerVector nbeta,
                              int n,
...
// ----------------------------------------------------------------------------
// CEM censored same sigma
// ----------------------------------------------------------------------------
// [[Rcpp::export]]
NumericVector CEMCensoredSigmaunique_cpp(NumericVector param,
                                         int ng,
                                         int nx,
                                         IntegerVector nbeta,
                                         int n,
  ...
  while (tour < itermax){
    ...
    if (nw == 0){
      ...
      b = 0;  // Initialiser b pour le calcul global de sigma
    ...
    // Calcul d'un sigma unique pour tous les groupes
    NumericVector vstmp = rep(sqrt(b/(period*n)), ng);
    rowvec newsigma(ng);
    newsigma = Rcpp::as<arma::rowvec>(vstmp);
